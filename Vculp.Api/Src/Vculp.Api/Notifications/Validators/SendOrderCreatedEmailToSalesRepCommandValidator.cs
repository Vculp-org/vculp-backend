...
{
    public class SendOrderCreatedEmailToSalesRepCommandValidator : CommandValidator<SendOrderCreatedEmailToSalesRepCommand>
    {
        public SendOrderCreatedEmailToSalesRepCommandValidator(IStringLocalizer<CommandValidatorMessages> stringLocalizer) : base(stringLocalizer)
        {
